        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-2xl font-bold text-white">PartNest</span>
            </div>
            <p className="text-gray-400">
              Connecting talented professionals with innovative companies. 
              Find your dream job or perfect candidate with PartNest.
            </p>
            {/* Social Links */}
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="flex">
                <input
                  ...
                  className="flex-grow px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-800 border-gray-700"
                  required
                />
                <button
                  type="submit"
              ...
              {subscriptionStatus && (
                <p className="text-green-400 text-sm">{subscriptionStatus}</p>
              )}
            </form>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © {new Date().getFullYear()} PartNest. All rights reserved.
            </div>
